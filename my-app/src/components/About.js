  ...
  return (
    <div className="about" id="about">
      ...
      <p>
        ...
        teknologi og koding. Når jeg ikke sitter foran skjermen, finner du meg
        ofte ute på tur i skogen, hvor jeg nyter naturen og det friske utelivet.
        Å holde meg aktiv er viktig for meg. Jeg liker å bruke tid på
        treningssenter. I tillegg er jeg glad i å reise og det å oppleve nye
